...
struct hexagonfs_file_ops {
	...
	int (*unlinkat)(struct hexagonfs_fd *dir, const char *name);
	int (*renameat)(struct hexagonfs_fd *olddir, const char *oldname,
			struct hexagonfs_fd *newdir, const char *newname);
	int (*dup)(struct hexagonfs_fd *src, struct hexagonfs_fd **out);
