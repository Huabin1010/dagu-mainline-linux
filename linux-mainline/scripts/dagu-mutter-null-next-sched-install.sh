#!/usr/bin/env bash
# ifgl next==NULL (0x1c4404): schedule_update(view), NOT schedule_update_now.
...
BR = 0x1C4404
BR_STOCK = 0xD65F03C0
PLT = 0x68200  # clutter_stage_view_schedule_update@plt (not _now)
VIEW_OFF = 136
...
def words():
    ...
    # 1d2b84: ldr x0,[x0,#136]   view
    # 1d2b88: cbz x0, 1d2b98
    # 1d2b8c: bl schedule_update@plt
