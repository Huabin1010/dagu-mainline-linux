// SM8250 Kryo 585 LPI copied from edk2-msm elish (same SoC).
// dagu board facts stay in dsdt_common.asl / himax.asl / graphics.asl.
// Do not treat this file as an elish DSDT.
Device (SYSM) { 
	Name (_HID, "ACPI0010")
	Name (_UID, 0x100000)
	Name (_LPI, Package()
